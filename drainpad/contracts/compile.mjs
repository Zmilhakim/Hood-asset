// Compiles the Drainpad contracts with solc-js, along with Uniswap's own pool
...
// is written out here rather than reconstructed later, where it could drift out of step.
...
const DEPLOYED = {
  "Drainpad.sol": "Drainpad",
  "Grate.sol": "Grate",
  "Sump.sol": "Sump",
  "DrainToken.sol": "DrainToken",
};
