...
//
// By default it collects ETH plus the token of every piece on the shelf that
...
const hook = await publicClient.readContract({ address: launchpad, abi: clayspadArtifact.abi, functionName: "hook" });
