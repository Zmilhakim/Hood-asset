// Compiles the Hoodpad v4 contracts with solc-js, along with the Uniswap v4 pool
...
// The web app imports these, so they are generated rather than copied: the
// frontend cannot drift from the contracts it is calling.
const abiDir = resolve(here, "..", "hoodpad", "src", "lib", "abi", "v4");
...
const DEPLOYED = {
  "HoodFeeHook.sol": "HoodFeeHook",
  "HoodToken.sol": "HoodToken",
  "HoodpadFactory.sol": "HoodpadFactory",
  "HoodpadLocker.sol": "HoodpadLocker",
};
...
for (const [file, name] of Object.entries(DEPLOYED)) {
  ...
  writeFileSync(
    ...
    `// Generated by contracts-v4/compile.mjs — do not edit by hand.\n` +
