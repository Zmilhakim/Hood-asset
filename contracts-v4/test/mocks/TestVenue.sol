...
/// `PoolManager`, deployed as it ships — a launch goes into the real
/// thing, with real flash accounting, real tick math and real hook dispatch —
/// not a model of any of it.
...
/// make a launch earn fees the only way anything ever does: somebody trades.
