...
import { cutpadPoolKey } from "./lib/pool.mjs";
...
console.log(`cut       3% of every swap, 80% of it to ${account.address}`);
...
console.log(`80% of the cut, which you take with \`npm run collect\`.`);
