...
/**
 * The pool a Cutpad launch opens: native ETH against the token, no LP fee, and
 * the cut hook in the key.
 *
 * All three are fixed properties of the pool rather than settings. `fee` is zero
 * because the cut is the whole fee schedule, and `hooks` is part of the key —
 ...
 */
export function cutpadPoolKey({ token, hook, tickSpacing }) {
  return {
