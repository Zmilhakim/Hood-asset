// The Cutpad marks, drawn as pixels rather than set in a typeface.
//
...
/** 7 x 9 glyphs with two-pixel strokes — only the letters CUTPAD needs. */
const GLYPHS = {
  T: ["#######", "..##...", "..##...", "..##...", "..##...", "..##...", "..##...", "..##...", "..##..."],
  O: [".#####.", "##...##", "##...##", "##...##", "##...##", "##...##", "##...##", "##...##", ".#####."],
  L: ["##.....", "##.....", "##.....", "##.....", "##.....", "##.....", "##.....", "##.....", "#######"],
...
export function wordmarkSvg({ text = "CUTPAD", unit = 8, color = PALETTE.ink } = {}) {
