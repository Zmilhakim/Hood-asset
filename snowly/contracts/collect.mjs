...
//
// By default it collects ETH plus the token of every drift on the snowfield that
...
const hook = await publicClient.readContract({ address: launchpad, abi: snowlyArtifact.abi, functionName: "hook" });
