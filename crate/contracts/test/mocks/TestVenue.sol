...
/// `PoolManager`, deployed as it ships — the crate is packed into the real
/// thing, with real flash accounting and real tick math, not a model of it.
...
/// make the crate earn fees the only way anything ever does: somebody buys.
